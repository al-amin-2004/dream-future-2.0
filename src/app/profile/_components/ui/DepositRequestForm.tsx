...
type DepositRequestFormProps = {
  open: boolean;
  setOpen: (v: boolean) => void;
};
type DepositRequestFormTypes = z.infer<typeof depositRequestSchema>;

const DepositRequestForm = ({ open, setOpen }: DepositRequestFormProps) => {
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<DepositRequestFormTypes>({
  ...
  const onSubmit = async (formData: DepositRequestFormTypes) => {
    setLoading(true);
